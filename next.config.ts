      ...
      headers: [
        {
          ...
          value: [
            ...
            "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.anthropic.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.tinkerschool.ai https://challenges.cloudflare.com",
        ...
        },
        {
          ...
          value: "camera=(), microphone=(), geolocation=(), serial=(self)",
        },
      ],
    },
  ],
